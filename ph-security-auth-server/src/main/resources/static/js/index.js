...
layui.config({
	...
	var form = layui.form(),
		...
		tab = layui.bodyTab({
			...
			url : "admin/user/system" //获取菜单json地址
		});
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							'<div class="admin-header-lock-img"><img src="images/face.png"/></div>'+
							'<div class="admin-header-lock-name" id="lockUserName">屏幕锁定</div>'+
							'<div class="input_btn">'+
...
function donation(){
	layer.tab({
		...
		tab : [{
			title : "微信",
			content : "<div style='padding:30px;overflow:hidden;background:#d2d0d0;'><img src='images/userface1.jpg'></div>"
		},{
			title : "支付宝",
			content : "<div style='padding:30px;overflow:hidden;background:#d2d0d0;'><img src='images/userface2.jpg'></div>"
		}]
	})
}
